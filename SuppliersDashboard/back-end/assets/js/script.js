...
(function ($) {
    ...
    $(".mode").on("click", function () {
        $('.mode i').toggleClass("ri-moon-line").toggleClass("ri-lightbulb-line");
        $('body').toggleClass("dark-only");
        
        var isDarkModeEnabled = $('body').hasClass("dark-only");
        localStorage.setItem('darkMode', isDarkModeEnabled ? 'enabled' : 'disabled');
    
        if (isDarkModeEnabled) {
            $('.mode i').removeClass("ri-moon-line").addClass("ri-lightbulb-line");
        } else {
            $('.mode i').removeClass("ri-lightbulb-line").addClass("ri-moon-line");
        }
    });
